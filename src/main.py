...
from api.aitunnel import AITunnelClient            # Клиент для взаимодействия с AI API через OpenRouter
...
class ChatApp:
    ...
    def __init__(self):
        ...
        self.api_client = AITunnelClient()       # Создание клиента для работы с AI API
